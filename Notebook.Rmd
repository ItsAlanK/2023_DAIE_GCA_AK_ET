...
print_ad_results <- function(tested_data) { # create a function with the name my_function
  ...
  { 
    print(paste("From the output obtained we can assume normality as the p-value of", round(tested_data$p.value, 4), "is greater than 0.05"))
  }
}
